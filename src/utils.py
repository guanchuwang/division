...
class MetricLogger:
    ...
    def log_every(self, iterable, print_freq, header=None, log_fname=None):
        i = 0
        if not header:
            header = ""
        ...
        for obj in iterable:
            ...
            if i % print_freq == 0:
                ...
                if log_fname is not None:
                    log_handle = open(log_fname, "a")
                    # log_handle.write(log_info)
                    print(log_info, file=log_handle)
                    log_handle.close()

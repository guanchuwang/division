...
class FDMP_(Function):
    ...
    def freq_divide(x, dct_op, window_size, device=None):
        ...
        x_hfc = torch.zeros_like(x, device=device)
    ...
    def fdmp_simulation(x, dct_op, window_size, device):
        ...
        x_lfc_dct, x_hfc = FDMP.freq_divide(x, dct_op, window_size, device=device)
        return x_lfc_dct, x_hfc
